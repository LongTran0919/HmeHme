            ...
            else
            {
                switch (color)
                {
                    case GhostColor.RED:
                        switch (D)
                        {
                            case Direction.DOWN: if (sprite1) return new Bitmap(Properties.Resources.rdown);
                                                else return new Bitmap(Properties.Resources.rdown);
                            case Direction.UP: if (sprite1) return new Bitmap(Properties.Resources.rup);
                                              else return new Bitmap(Properties.Resources.rup);
                            case Direction.RIGHT:if(sprite1) return new Bitmap(Properties.Resources.rdx);
                                                 else return new Bitmap(Properties.Resources.rdx);
                            case Direction.LEFT: if (sprite1) return new Bitmap(Properties.Resources.rsx);
                                                else return new Bitmap(Properties.Resources.rsx);
                            default: return null;
                        }
                    ...
                    case GhostColor.BLUE:
                        switch (D)
                        {
                            case Direction.DOWN: if (sprite1) return new Bitmap(Properties.Resources.adown);
                                                 else return new Bitmap(Properties.Resources.adown);
                            case Direction.UP: if (sprite1) return new Bitmap(Properties.Resources.aup);
                                               else return new Bitmap(Properties.Resources.aup);
                            case Direction.RIGHT: if (sprite1) return new Bitmap(Properties.Resources.adx);
                                                 else return new Bitmap(Properties.Resources.adx);
                            case Direction.LEFT: if (sprite1) return new Bitmap(Properties.Resources.asx);
                                                 else return new Bitmap(Properties.Resources.asx);
                    ...
                    case GhostColor.PINK:
                        ...
                        {
                            case Direction.DOWN:
                                if (sprite1) return new Bitmap(Properties.Resources.vdown);
                                else return new Bitmap(Properties.Resources.vdown);
                            case Direction.UP:
                                if (sprite1) return new Bitmap(Properties.Resources.vup);
                                else return new Bitmap(Properties.Resources.vup);
                            case Direction.RIGHT:
                                if (sprite1) return new Bitmap(Properties.Resources.vdx);
                                else return new Bitmap(Properties.Resources.vdx);
                            case Direction.LEFT:
                                if (sprite1) return new Bitmap(Properties.Resources.vsx);
                                else return new Bitmap(Properties.Resources.vsx);
                            default: return null;
                        }
                    ...
                    case GhostColor.YELLOW:
                        ...
                        {
                            case Direction.DOWN:
                                if (sprite1) return new Bitmap(Properties.Resources.gdown);
                                else return new Bitmap(Properties.Resources.gdown);
                            case Direction.UP:
                                if (sprite1) return new Bitmap(Properties.Resources.gup);
                                else return new Bitmap(Properties.Resources.gup);
                            case Direction.RIGHT:
                                if (sprite1) return new Bitmap(Properties.Resources.gdx);
                                else return new Bitmap(Properties.Resources.gdx);
                            case Direction.LEFT:
                                if (sprite1) return new Bitmap(Properties.Resources.gsx);
                                else return new Bitmap(Properties.Resources.gsx);
                            default: return null;
                        }
                    default: return null;
                }
